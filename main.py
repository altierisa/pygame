...
imagem_papel = pygame.image.load("papel.png")
imagem_tesoura = pygame.image.load("tesoura.png")
...
retangulo_papel = pygame.Rect(pos_papel[0], pos_papel[1], largura_imagem, altura_imagem)
...
while True:
    ...
    if evento.type == pygame.MOUSEBUTTONDOWN and estado == "aguardando":
        ...
        if escolha_jogador:
            ...
            if escolha_jogador == escolha_computador:
                ...
                pontos_computador =+ 1
            estado = "resultado"
            tempo_resultado = pygame.time.get_ticks
    ...
    if estado == "resultado":
            ...
            if retangulo_papel.collidepoint(pos_mouse):
